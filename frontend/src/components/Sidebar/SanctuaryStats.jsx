      ...
      {topEmotions.length > 0 && (
        ...
        >
          <div className="section-header">
            ...
            <span className="emotion-count">{Object.keys(emotion_distribution).length} types</span>
          </div>
        ...
        <div className="insights-list">
          {total_elements === 0 && (
            <div className="insight-item">
              <span className="insight-text">Your sanctuary journey is just beginning</span>
            </div>
          )}
          
          {total_elements > 0 && elements_this_week === 0 && (
            <div className="insight-item">
              <span className="insight-text">Consider sharing your thoughts this week</span>
            </div>
          )}
          ...
          {average_sentiment > 0.5 && (
            <div className="insight-item positive">
              <span className="insight-text">You're cultivating positive energy</span>
            </div>
          )}
          
          {session_duration > 7 && (
            <div className="insight-item positive">
              <span className="insight-text">Your dedication to growth shows</span>
            </div>
          )}
          
          {Object.keys(emotion_distribution).length > 5 && (
            <div className="insight-item">
              <span className="insight-text">You're exploring emotional diversity</span>
            </div>
          )}
